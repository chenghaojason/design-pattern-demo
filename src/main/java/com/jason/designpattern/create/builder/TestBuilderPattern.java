package com.jason.designpattern.create.builder;

import com.jason.commons.exception.NewInstanceException;
import com.jason.commons.utils.ParesXML;
import com.jason.designpattern.create.builder.computer.Computer;
import com.jason.designpattern.create.builder.computer.ComputerAbstractBuilder;
import com.jason.designpattern.create.builder.computer.Salesperson;
import com.jason.designpattern.create.builder.dy.*;
import com.jason.designpattern.create.builder.kfc.KFCWaiter;
import com.jason.designpattern.create.builder.kfc.Meal;
import com.jason.designpattern.create.builder.kfc.MealBuilder;
